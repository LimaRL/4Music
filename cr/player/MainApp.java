...
import cr.player.view.RootController;
...
public class MainApp extends Application {
    ...
    public static Database dbUser;
    
    /**
     * The data as an observable list of Musics.
     */
    public static ObservableList<Music> musicTable = FXCollections.observableArrayList();
    ...
    public MainApp() {
    	...
    	//start musics database "/database/database.txt"
    	db = new Database("database");
    	db.musicTable.forEach((key, value) -> {
    		musicTable.add(new Music(key, value));
		});
    	
    	//start musics database "/database/database_users.txt"
    	dbUser = new Database("database_users");
    }
